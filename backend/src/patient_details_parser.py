...
class PatientDetailsParser(MedicalDocParser):
    ...
    def parse(self):
        return {
            ...
            'phone_number': self.get_patient_phone(),
            'medical_problem': self.get_patient_medical_problems(),
             'vaccine': self.get_patient_vaccine()
        }
